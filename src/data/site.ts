...

  {
    ...
    children: [
      ...
      },
      {
        ...
        href: "/gallery?category=education",
      },
      {
        label: "Healthcare Initiative",
        href: "/gallery?category=healthcare",
      },
      {
        label: "Economic Empowerment",
        href: "/gallery?category=economic-empowerment",
      },
      {
        label: "Women & Youth",
        href: "/gallery?category=women-youth",
      },
    ],
  },
...
export const stats = [
  {
    ...
    description: "Individuals reached through our programmes",
  },
  {
    value: "₦2.1B+",
    label: "Funds Disbursed",
    description: "Grants, scholarships, and seed capital",
  },
  {
    value: "7+",
    label: "States Reached",
    description: "Active across at least 7 Nigerian states",
  },
  {
    value: "2021",
    label: "Year Founded",
    description: "Five years of sustained community impact",
  },
];
