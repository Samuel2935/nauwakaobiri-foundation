    ...
    >
      ...
      <nav className="max-w-7xl mx-auto px-6 flex items-center justify-between h-16 md:h-20">
        ...
        <Link href="/" className="flex items-center gap-3 group">
          <div className="w-10 h-10 bg-emerald-700 rounded-sm flex items-center justify-center text-white font-black text-sm font-display tracking-tight group-hover:bg-emerald-800 transition-colors">
            NUF
          </div>
