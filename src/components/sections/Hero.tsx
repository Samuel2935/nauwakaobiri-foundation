      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 pt-32 pb-20 w-full">
        <div className="max-w-3xl">
          ...
          <p className="text-gray-200 text-lg md:text-xl leading-relaxed max-w-xl mb-10">
            The N'Uwakaobiri Foundation empowers Nigerians youths through education,
            healthcare, and economic opportunity — building futures from the
            ground up.
          </p>
          ...
          <div className="flex flex-wrap gap-4 mb-16">
            ...
            <button className="inline-flex items-center gap-3 text-white text-sm font-semibold group">
              <span className="w-10 h-10 rounded-full border-2 border-white/40 flex items-center justify-center group-hover:border-emerald-400 group-hover:bg-emerald-400/10 transition-colors">
          ...
          <div className="flex flex-wrap gap-x-10 gap-y-4 border-t border-white/10 pt-8">
            {[
              { n: "12,400+", l: "Lives Impacted" },
              { n: "₦2.1B+", l: "Disbursed" },
              { n: "36 States", l: "Nationwide" },
            ].map((s) => (
              <div key={s.l}>
                <div className="font-display font-black text-white text-2xl leading-none">{s.n}</div>
                <div className="text-gray-400 text-xs mt-1 tracking-wide">{s.l}</div>
              </div>
            ))}
          </div>
        </div>
