    ...
    <section id="success-stories" className="py-24 bg-gray-50">
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-14">
          <div>
            <p className="text-emerald-700 text-xs font-bold uppercase tracking-[0.2em] mb-4">Real Impact</p>
          ...
          {stories.map((story) => (
            ...
            >
              ...
              <div className="p-6 flex flex-col flex-1">
                ...
                <p className="text-gray-500 text-sm leading-relaxed flex-1 mb-5">{story.body}</p>
                <div className="flex items-center justify-between border-t border-gray-100 pt-4">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm font-semibold text-gray-800">{story.name}</span>
                  </div>
                  <Link
