...
export default function DonateBanner() {
  return (
    <section id="donate" className="relative overflow-hidden bg-emerald-900 py-24">
      {/* Decorative pattern */}
      <div
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
        ...
        <p className="text-emerald-200 text-lg leading-relaxed max-w-2xl mx-auto mb-10">
          Every contribution — no matter the size — funds scholarships,
          medical outreaches, and micro-grants that transform communities
          across Nigeria. Be a part of this movement.
        </p>
